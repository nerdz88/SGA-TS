...
describe('Recuperer devoir étudiant', () => {
    ...
    it("Étudiant - Récuperer tous devoirs ", async (done) => {
    ...
    it("Étudiant - Récuperer un devoir ", async (done) => {
...
describe('Modifier/Supprimer devoir - Avec une remise', () => {
    ...
    it("Modifier un devoir d'un espace cours avec remise", async () => {
        ...
        expect(reponse.body.error.message).toBe("Impossible de modifier un devoir, ayant déjà une remise d'un étudiant");
    ...
    it("Supprimer un devoir avec remise", async () => {
        const reponse = await authenticatedSession.delete("/api/v1/enseignant/devoir/supprimer/1/1")
        expect(reponse.status).toBe(500)
        expect(reponse.body.error.message).toBe("Impossible de supprimer un devoir, ayant déjà une remise d'un étudiant");
